...
# plot 3: left bottom
a <- mutate(data_feb, t = parse_date_time(paste(data_feb$Date, data_feb$Time),"dmY hms"))
b <- select(a, t, Sub_metering_1, Sub_metering_2, Sub_metering_3)

with(b, plot(t, Sub_metering_1,  type = "l", 
             xlab="", ylab="Energy sub metering"))
with(b, lines(t, Sub_metering_2, type = "l", col = "blue"))
with(b, lines(t, Sub_metering_3, type = "l", col = "red"))
